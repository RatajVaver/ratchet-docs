...
- [:IsSwimming](/types/character#isswimming)
- [:IsFalling](/types/character#isfalling)
- [:IsFlying](/types/character#isflying)
...
- [:DeleteAllItems](/types/inventory#deleteallitems)
...
- [:GetStackSize](/types/item#getstacksize)
...
- [:GetDurability](/types/item#getdurability)
